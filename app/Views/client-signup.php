            ...
            <div class="col col-md-8 px-xl-5 mx-auto py-5 my-4">  
                <form method="POST" class="container" id="form" >
                    ...
                    <div class="row row-cols-1 row-cols-lg-2 mt-3">
                        <div class="col ps-1 ps-lg-2 ps-xxl-5">
                            ...
                            <label for="municipality" class="fw-bold display-7 form-label col-form-label col-form-label-sm mt-1 mt-lg-0">Municipality</label>
                                <input class="form-control form-control-sm py-2 py-xxl-3 fw-lighter" list="municipality-list" id="municipality" placeholder="Municipality" name="municipality">
                    ...
                    <div class="row row-cols-1 row-cols-lg-2 mt-3">
                        <div class="col ps-1 ps-lg-2 ps-xxl-5">
                            <div class="mt-xxl-3 mb-lg-2 d-flex flex-column">
                                <label for="client-shop-name" class="fw-bold display-7 form-label col-form-label col-form-label-sm mt-1 mt-lg-0">Shop Name</label>
                                <input type="text" name="client-shop-name" class="form-control form-control-sm py-2 py-xxl-3 fw-lighter" id="client-shop-name" placeholder="Shop Name">
                            </div>
                        </div>
                        ...
                        <div class="col ps-1 pe-lg-2 pe-xxl-5">
                            <div class="mt-xxl-3 mb-lg-2 d-flex flex-column">
                                ...
                                <select class="form-select form-select-sm py-2 py-xxl-3 fw-lighter" aria-label=".form-select-sm example" name="product-name">
        ...
        $(document).ready(function () {
            ...
            $('#email').keyup(function () { //check email availability
             var email = $('#email').val();
                if (email != ''){
                    $.ajax({
                        url: "<?= base_url('ClientSignup/check_Email'); ?>",
                        method: "POST",
                        dataType: "json",
                        data: {email:email},
            ...
            $('#form').submit(function (e) { 
                ...
                if(bool_cpass && bool_pass && bool_email && passcheck && bool_number){
                    ...
                    $.ajax({
                        type: "post",
                        url: "<?= base_url('ClientSignup/register');?>",
                        data: data,
                        dataType: "json",
                        contentType: false,
                        cache: false,
