...
<body>
	...
	<script src="<?= base_url() ?>/public/assets/bootstrap/path/js/bootstrap.min.js"></script>
	<script src="<?= base_url() ?>/public/assets/bootstrap/path/js/bootstrap.bundle.min.js"></script>
	<script type="" src="<?= base_url() ?>/public/assets/js/app.js"></script>
</body>
</html>